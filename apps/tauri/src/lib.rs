...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Tax commands
            commands::tax::get_tax_profile,
            commands::tax::update_tax_profile,
            commands::tax::get_account_tax_profiles,
            commands::tax::update_account_tax_profile,
            commands::tax::list_tax_year_reports,
            commands::tax::get_tax_year_report,
            commands::tax::create_tax_year_report,
            commands::tax::get_tax_report_detail,
            commands::tax::regenerate_tax_year_report,
            commands::tax::finalize_tax_year_report,
            commands::tax::amend_tax_year_report,
            commands::tax::upload_tax_document,
            commands::tax::list_tax_documents,
            commands::tax::delete_tax_document,
            commands::tax::get_tax_document_download,
            commands::tax::extract_tax_document,
            commands::tax::update_extracted_tax_field,
            commands::tax::reconcile_tax_year_report,
            commands::tax::update_tax_reconciliation_entry,
            commands::tax::update_tax_event,
            // Portfolio commands
            commands::portfolio::get_holdings,
            commands::portfolio::get_holding,
            commands::portfolio::get_asset_holdings,
            commands::portfolio::get_fee_analysis,
            ...
            commands::asset::update_expense_ratio,
